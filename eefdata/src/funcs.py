...
class DataFrameCompilation:
    ...
    def make_dataframe_2(self, save_file=True, clean_cols=False, verbose=True):
        ...
        int_evaluation = int_eval(self.data_extraction)
    ...
    def make_dataframe_5(self, save_file=True, clean_cols=True, verbose=True):
        ...
        sample_check = sample_main_check(self.data_extraction)
        ...
        group1N_df = group_desc_stats(self.data_extraction, "Data1", "out_g1_n_")
        group2N_df = group_desc_stats(self.data_extraction, "Data2", "out_g2_n_")
        group1mean_df = group_desc_stats(self.data_extraction, "Data3", "out_g1_mean_")
        group2mean_df = group_desc_stats(self.data_extraction, "Data4", "out_g2_mean_")
        group1sd_df = group_desc_stats(self.data_extraction, "Data5", "out_g1_sd_")
        group2sd_df = group_desc_stats(self.data_extraction, "Data6", "out_g2_sd_")
...
def group_desc_stats(json_extractor, attribute_text, column_prefix):
    ...
    outcometypeid = json_extractor.get_outcome_lvl1("OutcomeTypeId")  # noqa: uses param
...
def int_eval(json_extractor):
    ...
    int_eval_comments_df = json_extractor.process_info(int_eval_output, "out_eval_info")  # noqa: uses param
...
def sample_main_check(json_extractor):
